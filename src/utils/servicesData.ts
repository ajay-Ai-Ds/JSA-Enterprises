...
export const servicesData: Record<string, ServiceDetail> = {
  ...
  "pet-safety-nets": {
    ...
    beforeImage: "/images/main-images/pet.jpg",
    afterImage: "/images/main-images/pet.jpg",
  ...
  "duct-area-safety-nets": {
    ...
    beforeImage: "/images/hero/ductarea.webp",
    afterImage: "/images/hero/ductarea.webp",
  ...
  "monkey-safety-nets": {
    ...
    image: "/images/main-images/monkey.jpeg",
    supportingImages: [
      "/images/main-images/monkey.jpeg",
      "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=600&q=80",
      "https://images.unsplash.com/photo-1513694203232-719a280e022f?auto=format&fit=crop&w=600&q=80",
      "https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?auto=format&fit=crop&w=600&q=80",
    ],
    ...
    beforeImage: "/images/main-images/monkey.jpeg",
    afterImage: "/images/main-images/monkey.jpeg",
  ...
  "cricket-practice-nets": {
    ...
    supportingImages: [
      "/images/main-images/cricket.jpeg",
      "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=600&q=80",
      "https://images.unsplash.com/photo-1513694203232-719a280e022f?auto=format&fit=crop&w=600&q=80",
      "https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?auto=format&fit=crop&w=600&q=80",
    ],
    ...
    beforeImage: "/images/main-images/cricket.jpeg",
    afterImage: "/images/main-images/cricket.jpeg",
  ...
  "staircase-safety-nets": {
    ...
    category: "safety-nets",
    categoryName: "Safety Nets",
    title: "Staircase & Banister Safety Nets Installation Chennai | JSA",
    description: "Protect children, pets, and family members on open stairwells and banisters with durable high-density nylon safety nets.",
    longDescription: "Open stairwells and banisters in duplex homes, villas, and multi-story buildings present severe fall hazards. JSA Enterprises provides high-strength staircase safety nets designed to enclose stair openings securely. Made with UV-stabilized copolymer nylon mesh and anchored firmly with stainless steel hardware, our staircase safety nets offer complete fall protection without obstructing light or airflow.",
    aiOverview: "JSA Staircase Safety Nets protect children, pets, and adults from stairwell fall accidents. Woven with UV-resistant high-density nylon and anchored securely to banisters and walls, they close dangerous gaps with durable, transparent netting.",
    ...
    beforeImage: "/images/main-images/staircase-net-1.jpg",
    afterImage: "/images/main-images/staircase-net-1.jpg",
    benefits: [
      "Prevents Stairwell & Banister Falls",
      "Child & Pet Safety Protection",
      "High Impact Shock Absorption",
      "UV-Stabilized Weatherproof Nylon",
      "Custom Fit for Duplexes & Villas",
      "Free On-Site Inspection & Quote",
    ],
    specsTable: [
      { label: "Material", value: "HDPE Copolymer Nylon" },
      { label: "Mesh Size", value: "30mm to 50mm" },
      { label: "Thickness", value: "1.5mm to 3.0mm" },
      { label: "UV Resistance", value: "High (UV-Stabilized)" },
      { label: "Anchoring Hardware", value: "SS Expansion Hooks & Anchors" },
      { label: "Maintenance", value: "Wash with water / microfiber wipe" },
    ],
    faqs: generateFAQsForService("Staircase Safety Nets", "safety-nets"),
  },
...
const imageOverrides: Record<string, string> = {
  ...
  "pet-safety-nets": "/images/main-images/pet.jpg",
